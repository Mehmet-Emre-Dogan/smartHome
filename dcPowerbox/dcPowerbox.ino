...
#define EEPROM_SCL D2
#define EEPROM_SDA D1
#define EEPROM_TYPE "24C32" // The other model I have tested is "24C088"
...
String title = "Powerbox";

byte relayStates[NUM_RELAYS] = {1, 1, 1, 1};
const int relays[NUM_RELAYS] = {D5, D6, D7, D8};
...
String deviceNames[NUM_RELAYS] = {"Music Visualizer", "Ambiance Lamp", "Fans", "Laptop Cooler"};
